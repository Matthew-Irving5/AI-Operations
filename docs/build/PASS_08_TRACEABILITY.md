...
| 30    | Unit, database, integration, AI evaluation, browser, security, and performance gates       | PARTIAL | Empty-db reset, all 65 pgTAP/RLS tests, Chromium/WebKit Playwright, TypeScript/Deno suites pass locally; security, k6, and complete AI-evaluation evidence remain outstanding.      |
