...
| 30    | Unit, database, integration, AI evaluation, browser, security, and performance gates       | UNTESTED | TypeScript/Deno suites pass locally; Docker is unavailable, so database/RLS and local E2E suites cannot yet run.                                       |
